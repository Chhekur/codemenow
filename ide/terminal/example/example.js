...
.config(['terminalConfigurationProvider', function (terminalConfigurationProvider) {
    ...
    terminalConfigurationProvider.config('vintage').typeSoundUrl ='/ide/terminal/example/content/type.wav';
    terminalConfigurationProvider.config('vintage').startSoundUrl ='/ide/terminal/example/content/start.wav';
}])
